...
class VideoBridge:
    ...
    async def initialize(self):
        ...
        try:
            ...
            logger.info(f"⚡ Study Hub Bridge connected as @{self.me.username} (ID: {self.me.id})")
    ...
    async def fetch_and_forward_to_bot(self, student_chat_id: int, payload: dict, quality: str = '720p', timeout: int = 60, caption: str = ""):
        ...
        3. Relays the video cleanly (no forward header) with custom caption to @StudyBot.
        """
        ...
        # Send video cleanly directly to @StudyBot
        try:
            ...
            # - Sets custom caption ending with ⚡ Powered by Study Hub
