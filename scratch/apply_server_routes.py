...
if start_marker not in server_code:
...
if start_idx != -1 and end_idx != -1:
  new_server_code = server_code[:start_idx] + as_routing_block.strip() + '\n\n\n' + server_code[end_idx:]
  with open(server_index_path, 'w', encoding='utf-8') as f:
    f.write(new_server_code)
  print('Successfully updated server/index.js with clean routing!')
else:
